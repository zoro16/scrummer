...
SECRET_KEY = 'lockg)uxapd5)c1a-n1gwcapw*m2)k^t*=$o=!^93d@85kw4se'
...
# NOTE: You need to create the Bitbucket > Settings > OAuth > Add Consumer
# Example: http://bit.ly/2mCfryk
BITBUCKET_CONSUMER_KEY = None
BITBUCKET_CONSUMER_SECRET = None
BITBUCKET_CONSUMER_USERNAME = None
